 ...
 * Description: Plugin pour afficher des radars sur une carte Mapbox avec des markers spécifiques et des options de filtre.
 * Version: 1.1
...
function wp_map_radars_enqueue_scripts() {
    ...
    wp_enqueue_script('wp-map-radars', plugins_url('js/map.js', __FILE__), ['mapbox-gl', 'jquery'], '1.1', true);
...
// Shortcode pour afficher la map et les filtres
function wp_map_radars_shortcode() {
    return '
        <div id="radar-filters" style="margin-bottom: 20px;">
            <label><input type="checkbox" value="Radar fixe" checked> Radar fixe</label>
            <label><input type="checkbox" value="Radar feu rouge" checked> Radar feu rouge</label>
        </div>
