 ...
 * Description: Plugin pour afficher des radars sur une carte Mapbox.
 * Version: 1.3
...
function wp_map_radars_enqueue_scripts() {
    ...
    wp_enqueue_script('wp-map-radars', plugins_url('js/map.js', __FILE__), ['mapbox-gl', 'jquery'], '1.3', true);
